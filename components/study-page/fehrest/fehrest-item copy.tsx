...
//           <CollapsibleContent
//             render={<ol />}
//             className="border-r-2 pr-1 mb-2 mr-3 overflow-hidden h-(--collapsible-panel-height) transition-all duration-300 data-starting-style:h-0 data-ending-style:h-0"
//           >
//             {section.sections?.map((subSection) => (
//               <FehrestItem
//                 key={subSection.title}
